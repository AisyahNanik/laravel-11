...
<head>
    ...
    <title>Data Siswa - NilaiSiswa.com</title>
...
<body style="background: lightgray">
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-12">
                <div>
                    <h3 class="text-center my-4">Nilai Ujian Para Siswa</h3>
                    <h5 class="text-center"><a href="https://NilaiSiswa.com">www.NilaiSiswa.com</a></h5>
                    <hr>
                </div>
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <a href="{{ route('siswas.create') }}" class="btn btn-md btn-success mb-3">ADD SISWA</a>
